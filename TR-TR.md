...
* [.Net Geliştiricileri İçin AngularJS] (http://henriquat.re/)
* [AngularJS ile Web Uygulaması Geliştirmek] (http://www.packtpub.com/angularjs-web-application-development/book)
* [AngularJS Sınırlarında Geliştirmek] (http://bleedingedgepress.com/our-books/developing-an-angularjs-edge/)
...
* [Video Rehber: 60 Dakikada AngularJS Temelleri](http://weblogs.asp.net/dwahlin/archive/2013/04/12/video-tutorial-angularjs-fundamentals-in-60-ish-minutes.aspx) — 1:10:50
* [AngularJS YouTube Kanalı](http://www.youtube.com/user/angularjs) — several videos, mostly presentations of 1h or more
* [AngularJS'e Giriş](http://www.youtube.com/watch?v=8ILQOFAgaXE) — 50:05
* [Angular JS ile Baştan Sona](http://www.youtube.com/watch?v=hqAyiqUs93c) — 52:59
* [Angular JS ile Güvenlik](http://www.youtube.com/watch?v=18ifoT-Id54) — 29:45
* [Grunt ve Angular JS ile Önyüz İş Akışı](http://www.youtube.com/watch?v=fSAgFxjFSqY) — 1:02:37
* [AngularJS Rehberi](http://www.youtube.com/watch?v=WuiHuZq_cg4) — 12:19
* [AngularJS'de Göster Bana (Tekpub)](http://tekpub.com/products/angular) — 8 videos (paid)
* [AngularJS ile Zahmetsiz JavaScript Uygulamaları (Tuts+)](https://tutsplus.com/course/easier-js-apps-with-angular/) — 22 videos of about 5 minutes each, in 8 sections (paid)
* [AngularJS Temelleri (Pluralsight)] (http://pluralsight.com/training/Courses/TableOfContents/angularjs-fundamentals) - 6 hours 15 minutes total (paid)
* [AngularJS 1.2 ve Dahası] (http://www.youtube.com/watch?v=W13qDdJDHp8&feature=youtu.be)

## Kurslar

* [Thinkster.io - AngularJS'i Öğrenmek İçin Daha İyi Bir Yol](http://www.thinkster.io/) - Free course on AngularJS

## Yardım Toplulukları
* [StackOverflow] (http://stackoverflow.com/questions/tagged/angularjs)
* [AngularJS Mail Listesi (Google Groups)] (http://groups.google.com/group/angular)
* [Sohbet Odası (Tarayıcı tabanlı)] (http://webchat.freenode.net/?channels=angularjs&uio=d4)
* [AngularJS Google+ Topluluğu] (https://plus.google.com/u/0/communities/115368820700870330756)

## Genel Konular
* [AngularJS Referansı] (http://www.cheatography.com/proloser/cheat-sheets/angularjs/)
* [AngularJS ile Eğlenin] (http://devgirl.org/2013/03/21/fun-with-angularjs/)
* [AngularJS Philly ETE Sunumu] (http://onehungrymind.com/angularjs-philly-ete-slides/)
...
## AngularJS'de Servisler/Sağlayıcılar (Services/Providers)
...
## AngularJS'de Yönlendirmeler (Routing)
...
## AngularJS'de Vaatler/Asenkron istekler (Promises/Deferred)
...
## AngularJS'de Kolleksiyonlar (Collections (& ngRepeat Stuff))
...
## Diğer diller/framework'ler ile Entegrasyon
