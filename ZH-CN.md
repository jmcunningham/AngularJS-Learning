...
## 开发工具
* [AngularJS Batarang Chrome 扩展](https://github.com/angular/angularjs-batarang)
* [从JSON或者restful API生成JavaScript和HTML，使用AngularJS和JQuery](http://spascaffold.azurewebsites.net/AngularJSScaffold)